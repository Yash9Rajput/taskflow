    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}
      ...
      <div className="modal-box"
        style={{
          maxWidth: 520,
          width: '100%',
          maxHeight: '88vh',       /* never taller than viewport */
          display: 'flex',
            ...
            {[
              {
                label: 'Assignee',
                content: assignee
                  ? <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}><Avatar user={assignee} size={24} /><span style={{ fontSize: 13 }}>{assignee.name}</span></div>
